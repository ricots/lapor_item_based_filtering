...
public class adapter_rekomendasi extends RecyclerView.Adapter<adapter_rekomendasi.ViewHolder> {
    private ImageLoader imageLoader;
    private Context context;
    List<Item> laporan;
    ArrayList<String> lokasinya;
   int tot, rat,rekom,tot_rekom,hasil;


    public adapter_rekomendasi(List<Item> laporan, Context context){
        super();
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_rekomendasi, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.hasilnya.setText("total rekomendasi " + lapor.getRekomendasi());
        holder.judul_rekom.setText(lapor.getJudul());
        holder.item = lapor;
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public TextView total,id_lapor,ratingnya,rating_lapor,hasilnya;
        public TextView judul_rekom;
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            imageView = (NetworkImageView) itemView.findViewById(R.id.img_rekomendasi);
            id_lapor = (TextView) itemView.findViewById(R.id.id_lapor_rekomendasi);
            ratingnya = (TextView) itemView.findViewById(R.id.ratingnya);
            rating_lapor = (TextView) itemView.findViewById(R.id.rating_lapor);
            total = (TextView) itemView.findViewById(R.id.total);
            hasilnya = (TextView) itemView.findViewById(R.id.hasilnya);
            judul_rekom = (TextView) itemView.findViewById(R.id.judul_rekom);
